...
--mp_coop_start                           
	--BlueFirstToEnd
		...
		SceneTable["mp_coop_startBlueFirstToEnd02"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_GET_GUN13.vcd"),postdelay=0.2,next=nil,char="glados"}
	--BlueGetsGunFirst
		--Blue is first to acquire a Portal Device.
		SceneTable["mp_coop_startBlueGetsGunFirst01"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_GET_GUN02.vcd"),postdelay=0.000,next=nil,char="glados"}
	--BlueGetsGunSecond
		--Blue now has a Portal Device. Finally.
		SceneTable["mp_coop_startBlueGetsGunSecond01"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_GET_GUN04.vcd"),postdelay=1.5,next=nil,char="glados",fires={{entity="gun_room_open_doors",input="Trigger",parameter="",delay=0.0}},queue=1,queueforcesecs=6}
	--BlueInterruptsRelaxationVault
		...
		SceneTable["mp_coop_startBlueInterruptsRelaxationVault05"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_VAULT_INTERRUPTION09.vcd"),postdelay=0.000,next=nil,char="glados",fires={{entity="player_2_relay_open_portals",input="Trigger",parameter="",delay=0.0}}}
	--coop_boxcalibration
		...
		SceneTable["mp_coop_startcoop_boxcalibration03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_calibration05.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_buttoncallibrationblue
		--Calibrating Blue's weight...
		SceneTable["mp_coop_startcoop_buttoncallibrationblue00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_calibration01.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_buttoncallibrationorange
		...
		--No variances detected.
		SceneTable["mp_coop_startcoop_buttoncallibrationorange02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_calibration06.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_callibrationcomplete1
		...
		SceneTable["mp_coop_startcoop_callibrationcomplete101"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_callibrationcomplete02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00,fireatstart=true}}}
	...
	--coop_ping_intro_animal
		...
		SceneTable["mp_coop_startcoop_ping_intro_animal02"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro04.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_ping_intro_blue_nag
		--BLUE, please use your ping tool to select your favorite animal.
		SceneTable["mp_coop_startcoop_ping_intro_blue_nag01"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro04.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_ping_intro_orange_nag
		--ORANGE, please use your ping tool to select your favorite element from the periodic table.
		SceneTable["mp_coop_startcoop_ping_intro_orange_nag01"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro08.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_ping_orange_start
		--ORANGE, please use your ping tool to select your favorite element from the periodic table.
		SceneTable["mp_coop_startcoop_ping_orange_start01"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro08.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="relay_begin_ping_2",input="Trigger",parameter="",delay=0.00}}}
	--coop_ping_orange_success
		...
		SceneTable["mp_coop_startcoop_ping_orange_success03"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro10.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="relay_ping_2_move_on",input="Trigger",parameter="",delay=1.00}}}
	--coop_portal_ping_intro
		...
		SceneTable["mp_coop_startcoop_portal_ping_intro02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_pingtool01.vcd"),postdelay=0.5,next=nil,char="glados",fires={{entity="@glados",input="runscriptcode",parameter="GladosPingIntroDone()",delay=0.00}}}
	--coop_pregun_pingnag1blue
		...
		SceneTable["mp_coop_startcoop_pregun_pingnag1blue01"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_pingtool02.vcd"),postdelay=0.00,next=nil,char="glados",queue=1,queuetimeout=5}
	--coop_pregun_pingnag1orange
		...
		--I can only place a portal on a white portalable surface.
		SceneTable["mp_coop_startcoop_pregun_pingnag1orange01"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_pingtool02.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_pregun_pingnag2blue
		...
		SceneTable["mp_coop_startcoop_pregun_pingnag2blue01"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_pingtool03.vcd"),postdelay=0.00,next=nil,char="glados",queue=1,queuetimeout=5}
	--coop_pregun_pingnag2orange
		...
		--Please ping a white portalable surface.
		SceneTable["mp_coop_startcoop_pregun_pingnag2orange01"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_pingtool03.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_results_1_01
		...
		SceneTable["mp_coop_startcoop_results_1_0100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startend02.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_startboxcatch
		--Nice catch, Orange.
		SceneTable["mp_coop_startcoop_startboxcatch00"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_MISC10.vcd"),postdelay=0.00,next=nil,char="glados",predelay=1,queue=1,queueforcesecs=5,queuetimeout=7,skipifbusy=1}
	--coop_starttwoportals
		...
		SceneTable["mp_coop_startcoop_starttwoportals01"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_pingtool07.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_startdeath01
		--Don't worry.  You can't die.  They will just reassemble you.
		SceneTable["mp_coop_startmp_coop_startdeath0100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startdeath01.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_startdeath02
		--Did you do that on purpose?
		SceneTable["mp_coop_startmp_coop_startdeath0200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startdeath02.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_startdeath03
		--It seems rather earlier to require reassembly.
		SceneTable["mp_coop_startmp_coop_startdeath0300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startdeath03.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_startdeath04
		--Oh... can someone reassemble Orange?
		SceneTable["mp_coop_startmp_coop_startdeath0400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startdeath04.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_startdeath05
		--Oh... can someone reassemble Blue?
		SceneTable["mp_coop_startmp_coop_startdeath0500"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startdeath05.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_startposttaunt
		...
		--Now let's continue testing.
		SceneTable["mp_coop_startmp_coop_startposttaunt03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_startend02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--OneBlah
		--Blah.
		SceneTable["mp_coop_startOneBlah01"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH37.vcd"),postdelay=0.000,next=nil,char="glados"}
	--OrangeFirstToEnd
		...
		--Again, those are science collaboration points, which you should not confuse with points from competitions such as Who-Gets-To-Live-At-The-End-And-Who-Doesn�t. I mean basketball.
		SceneTable["mp_coop_startOrangeFirstToEnd02"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_GET_GUN13.vcd"),postdelay=0.2,next=nil,char="glados"}
	--OrangeGetsGunFirst
		--Orange is first to acquire a Portal Device.
		SceneTable["mp_coop_startOrangeGetsGunFirst01"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_GET_GUN01.vcd"),postdelay=0.000,next=nil,char="glados"}
	--OrangeGetsGunSecond
		--Orange now has a Portal Device. Finally.
		SceneTable["mp_coop_startOrangeGetsGunSecond01"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_GET_GUN03.vcd"),postdelay=1.5,next=nil,char="glados",fires={{entity="gun_room_open_doors",input="Trigger",parameter="",delay=0.0}},queue=1,queueforcesecs=6}
	--OrangeInterruptsRelaxationVault
		...
		SceneTable["mp_coop_startOrangeInterruptsRelaxationVault05"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_VAULT_INTERRUPTION08.vcd"),postdelay=0.000,next=nil,char="glados",fires={{entity="player_2_relay_open_portals",input="Trigger",parameter="",delay=0.0}}}
	--RelaxationVaultIntro
		...
		SceneTable["mp_coop_startRelaxationVaultIntro02"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro01.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="relay_gesture_hints",input="Trigger",parameter="",delay=0.00}}}
	--TTT2GO1
		...
		SceneTable["mp_coop_startTTT2GO103"] = {vcd=CreateSceneEntity("scenes/npc/glados/coop_teamwork_exercise_alt13.vcd"),postdelay=0.000,next=nil,char="glados"}
	--TTT2GO2
		...
		--Game over. Back to testing.
		SceneTable["mp_coop_startTTT2GO202"] = {vcd=CreateSceneEntity("scenes/npc/glados/coop_teamwork_exercise_alt13.vcd"),postdelay=0.000,next=nil,char="glados"}
	--TTT2Intro
		...
		--Blue, you go first.
		SceneTable["mp_coop_startTTT2Intro05"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEAMWORK_EXERCISE_ALT05.vcd"),postdelay=0.2,next=nil,char="glados",fires={{entity="glados",input="runscriptcode",parameter="GladosCoopPingTrainingGameOn()",delay=0.00}}}
--mp_coop_doors                           
	--coop_score_blue05
		--Blue receives
		...
		SceneTable["mp_coop_doorscoop_score_blue0503"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=0.00,next=nil,char="glados",queue=1,queuetimeout=2}
	--coop_score_orange05
		--Orange receives
		...
		--science collaboration points.
		SceneTable["mp_coop_doorscoop_score_orange0503"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=0.00,next=nil,char="glados",queue=1,queuetimeout=2}
	--mo_coop_doorsend
		...
		SceneTable["mp_coop_doorsmo_coop_doorsend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_competition01.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00,fireatstart=true}}}
	--mp_coop_doorsstart
		...
		SceneTable["mp_coop_doorsmp_coop_doorsstart03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_doors03.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_teamworkdeath1
		--There you are, reassembled again.
		SceneTable["mp_coop_doorsmp_coop_teamworkdeath100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge30.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_teamworkdeath2
		--Without the consequence of death, is this even science?
		SceneTable["mp_coop_doorsmp_coop_teamworkdeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge35.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_teamworkdeath3
		--With humans, I would have called that a successful test.
		SceneTable["mp_coop_doorsmp_coop_teamworkdeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge32.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_teamworkdeath4
		--How is this even science, without the possibility of death?
		SceneTable["mp_coop_doorsmp_coop_teamworkdeath400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge33.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_teamworkdeath5
		--How is this even science, without the consequence of death?
		SceneTable["mp_coop_doorsmp_coop_teamworkdeath500"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge34.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
--mp_coop_race_2                          
	--EndLevel07
		...
		SceneTable["mp_coop_race_2EndLevel0702"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH15.vcd"),postdelay=0.000,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_race_2start
		...
		SceneTable["mp_coop_race_2mp_coop_race_2start02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_race_2start02.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_laser_2                         
	--coop_laser_2end
		...
		SceneTable["mp_coop_laser_2coop_laser_2end00"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH01.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_score_blue03
		--Blue receives
		...
		--science collaboration points.
		SceneTable["mp_coop_laser_2coop_score_blue0303"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=0.00,next=nil,char="glados",queue=1,queuetimeout=2}
	--coop_score_blue08
		--Blue receives
		...
		--science collaboration points.
		SceneTable["mp_coop_laser_2coop_score_blue0803"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=0.00,next=nil,char="glados",queue=1,queuetimeout=2}
	--coop_score_orange03
		--Orange receives
		...
		--science collaboration points.
		SceneTable["mp_coop_laser_2coop_score_orange0303"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=0.00,next=nil,char="glados",queue=1,queuetimeout=2}
	--coop_score_orange08
		--Orange receives
		...
		--science collaboration points.
		SceneTable["mp_coop_laser_2coop_score_orange0803"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=0.00,next=nil,char="glados",queue=1,queuetimeout=2}
	--EndLevel04
		...
		--Please continue into the next test chamber.
		SceneTable["mp_coop_laser_2EndLevel0402"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH15.vcd"),postdelay=0.000,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_laserkill
		...
		SceneTable["mp_coop_laser_2mp_coop_laserkill03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_203.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_laser_2taunt
		...
		SceneTable["mp_coop_laser_2mp_coop_laser_2taunt02"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt10.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_rat_maze                        
	--mp_coop_blue_penalized_4
		...
		--science collaboration points.
		SceneTable["mp_coop_rat_mazemp_coop_blue_penalized_403"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_laser_2endblue
		...
		SceneTable["mp_coop_rat_mazemp_coop_laser_2endblue03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_209.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_laser_2endorange
		...
		SceneTable["mp_coop_rat_mazemp_coop_laser_2endorange03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_210.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_orange_penalized_4
		...
		--science collaboration points.
		SceneTable["mp_coop_rat_mazemp_coop_orange_penalized_403"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_rat_mazebluecrush
		...
		SceneTable["mp_coop_rat_mazemp_coop_rat_mazebluecrush00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_crushercrush01.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
	--mp_coop_rat_mazebluecrush2
		...
		SceneTable["mp_coop_rat_mazemp_coop_rat_mazebluecrush200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_crushercrush03.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
	--mp_coop_rat_mazebluecrush3
		--Orange, now you're just being cruel.  Orange receives 25 science collaboration points.
		SceneTable["mp_coop_rat_mazemp_coop_rat_mazebluecrush300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_crushercrush05.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
	--mp_coop_rat_mazeorangecrush
		...
		SceneTable["mp_coop_rat_mazemp_coop_rat_mazeorangecrush00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_crushercrush02.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
	--mp_coop_rat_mazeorangecrush2
		...
		SceneTable["mp_coop_rat_mazemp_coop_rat_mazeorangecrush200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_crushercrush04.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
	--mp_coop_rat_mazeorangecrush3
		--Blue, now you're just being cruel.  Blue receives 25 science collaboration points.
		SceneTable["mp_coop_rat_mazemp_coop_rat_mazeorangecrush300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_crushercrush06.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
	--mp_coop_rat_mazestart
		...
		SceneTable["mp_coop_rat_mazemp_coop_rat_mazestart01"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_test_chamber_both09_01.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_laser_crusher                   
	--mp_coop_laser_crusherblue
		...
		SceneTable["mp_coop_laser_crushermp_coop_laser_crusherblue00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_rat_mazedeath01.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
	--mp_coop_laser_crusherboth
		...
		SceneTable["mp_coop_laser_crushermp_coop_laser_crusherboth00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_rat_mazedeath04.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
	--mp_coop_laser_crusherdeathend
		...
		SceneTable["mp_coop_laser_crushermp_coop_laser_crusherdeathend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_laser_crusher01.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_laser_crusherorange
		...
		--Until now.
		SceneTable["mp_coop_laser_crushermp_coop_laser_crusherorange02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_rat_mazedeath03.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_laser_crusherstartblue
		...
		--It's not, though.
		SceneTable["mp_coop_laser_crushermp_coop_laser_crusherstartblue03"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_competition05.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_laser_crusherstartorange
		...
		--It's not, though.
		SceneTable["mp_coop_laser_crushermp_coop_laser_crusherstartorange03"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_competition05.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_teambts                         
	--mp_coop_radarroomend
		...
		SceneTable["mp_coop_teambtsmp_coop_radarroomend03"] = {vcd=CreateSceneEntity("scenes/npc/glados/coop_hub_track04.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_teambtsstart
		...
		SceneTable["mp_coop_teambtsmp_coop_teambtsstart03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_teambtsstart03.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_teambtsstoptaunt1b
		--For that Blue is penalized fifty science collaboraiton points.
		SceneTable["mp_coop_teambtsmp_coop_teambtsstoptaunt1b00"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt16.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=1.5,skipifbusy=1}
	--mp_coop_teambtsstoptaunt1o
		--For that Orange is penalized fifty science collaboraiton points,
		SceneTable["mp_coop_teambtsmp_coop_teambtsstoptaunt1o00"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt17.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=1.5,skipifbusy=1}
	--mp_coop_teambtsstoptaunt2
		...
		SceneTable["mp_coop_teambtsmp_coop_teambtsstoptaunt202"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt19.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,skipifbusy=1}
	--mp_coop_teambtsstoptaunt3b
		--Fine, 500 point penalty for Blue.
		SceneTable["mp_coop_teambtsmp_coop_teambtsstoptaunt3b00"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt20.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=1.5,skipifbusy=1}
	--mp_coop_teambtsstoptaunt3o
		--Fine, 500 point penalty for Orange.
		SceneTable["mp_coop_teambtsmp_coop_teambtsstoptaunt3o00"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt21.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=1.5,skipifbusy=1}
	--mp_coop_teambtsstoptaunt4
		--5000 point penalty! Are you happy now?
		SceneTable["mp_coop_teambtsmp_coop_teambtsstoptaunt400"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt22.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=1.5,skipifbusy=1}
	--mp_coop_teambtsstoptaunt5
		...
		--I'm done.
		SceneTable["mp_coop_teambtsmp_coop_teambtsstoptaunt502"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt23.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,skipifbusy=1}
--mp_coop_fling_3                         
	--mp_coop_fling_3end
		...
		SceneTable["mp_coop_fling_3mp_coop_fling_3end04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_3end04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_fling_3start
		...
		SceneTable["mp_coop_fling_3mp_coop_fling_3start03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_3start03.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_infinifling_train               
	--mp_coop_infinifling_traindeath01
		--Was that necessary?
		SceneTable["mp_coop_infinifling_trainmp_coop_infinifling_traindeath0100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death26.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2.5,skipifbusy=1}
	--mp_coop_infinifling_trainend
		...
		SceneTable["mp_coop_infinifling_trainmp_coop_infinifling_trainend04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_infinifling_trainend04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_infinifling_trainenddeath
		...
		SceneTable["mp_coop_infinifling_trainmp_coop_infinifling_trainenddeath00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_1end01_01.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_infinifling_trainendlife
		...
		SceneTable["mp_coop_infinifling_trainmp_coop_infinifling_trainendlife00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_1end03.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_infinifling_trainstart
		...
		SceneTable["mp_coop_infinifling_trainmp_coop_infinifling_trainstart04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_infinifling_trainstart04.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_come_along                      
	--mp_coop_come_alongenddeath
		...
		SceneTable["mp_coop_come_alongmp_coop_come_alongenddeath00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_come_along06.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_come_alongendnodeath
		--And they said no one would ever die during this test, thanks for proving them wrong.
		SceneTable["mp_coop_come_alongmp_coop_come_alongendnodeath00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_come_along04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_come_alongstart
		...
		SceneTable["mp_coop_come_alongmp_coop_come_alongstart04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_come_alongstart04.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_fling_1                         
	--mp_coop_fling_14balls
		--Begin juggling test in three. Two. One.
		SceneTable["mp_coop_fling_1mp_coop_fling_14balls00"] = {vcd=CreateSceneEntity("scenes/npc/glados/multiple_spheres01.vcd"),postdelay=0.00,next=nil,char="glados",predelay=3}
--mp_coop_catapult_1                      
	--mp_coop_catapult_1end
		...
		SceneTable["mp_coop_catapult_1mp_coop_catapult_1end03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_catapult_1end03.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_catapult_1start
		...
		SceneTable["mp_coop_catapult_1mp_coop_catapult_1start04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_confidencenotstay04.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_multifling_1                    
	--mp_coop_multifling_1cube1
		--Excellent work.
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1cube100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_doors01a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_multifling_1cube2
		--Good Job.
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1cube200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_doors02a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_multifling_1cube3
		--You are doing wonderfully.
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1cube300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_doors04a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_multifling_1cube4
		--Excellent.
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1cube400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_doors05a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_multifling_1end
		...
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1end02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_confidenceoff02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_multifling_1endnodeath
		...
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1endnodeath02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_confidenceoff04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_multifling_1start
		...
		SceneTable["mp_coop_multifling_1mp_coop_multifling_1start03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_confidencenotperfect03.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_fling_crushers                  
	--mp_coop_fling_crushersdeath1
		...
		SceneTable["mp_coop_fling_crushersmp_coop_fling_crushersdeath100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_crushers01.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_fling_crushersdeath2
		...
		SceneTable["mp_coop_fling_crushersmp_coop_fling_crushersdeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_crushers02.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_fling_crushersend
		--Excellent.  I think you have earned a break from the official testing courses.
		SceneTable["mp_coop_fling_crushersmp_coop_fling_crushersend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_crushersend01.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_fling_crushersend2
		--I think after that display, we should take a break from the official testing courses.
		SceneTable["mp_coop_fling_crushersmp_coop_fling_crushersend200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fling_crushersend03.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_fling_crushersstart
		...
		SceneTable["mp_coop_fling_crushersmp_coop_fling_crushersstart04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_confidencenotslow04_01.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_fan                             
	--mp_coop_fanend
		...
		SceneTable["mp_coop_fanmp_coop_fanend03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fanend03.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_explode_bots_transition",input="Trigger",parameter="",delay=1.25,fireatstart=true}}}
	--mp_coop_fanstart
		...
		SceneTable["mp_coop_fanmp_coop_fanstart03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_fan04.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_wall_intro                      
	--mp_coop_wall_introstart
		...
		SceneTable["mp_coop_wall_intromp_coop_wall_introstart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_obstacletrait02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_wall_introstart2
		...
		SceneTable["mp_coop_wall_intromp_coop_wall_introstart202"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro02.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_wall_2                          
	--EndLevel08
		--Very good. You�ve really come together as a team. Thanks to the one of you who appears to be doing all of the work.
		SceneTable["mp_coop_wall_2EndLevel0801"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH08.vcd"),postdelay=0.000,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_wall_2start
		--You did very well.
		...
		SceneTable["mp_coop_wall_2mp_coop_wall_2start02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_wall_2start2
		...
		SceneTable["mp_coop_wall_2mp_coop_wall_2start202"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro08.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00,fireatstart=true}},predelay=0.5}
	--mp_coop_wall_2start3
		...
		SceneTable["mp_coop_wall_2mp_coop_wall_2start304"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro06.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_wall_2start4
		...
		--times in this test.  Not that it matters. It doesn't.  So congratulations  job well done.
		SceneTable["mp_coop_wall_2mp_coop_wall_2start404"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_intro06.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_wall_2startreal
		...
		SceneTable["mp_coop_wall_2mp_coop_wall_2startreal00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_turret_ball01.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_catapult_wall_intro             
	--Cackle
		--[Laughter]
		SceneTable["mp_coop_catapult_wall_introCackle01"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_LAUGH01.vcd"),postdelay=0.000,next=nil,char="glados"}
	--CatchBall
		--Good work! Now throw the ball over the ledge.
		SceneTable["mp_coop_catapult_wall_introCatchBall01"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_MISC12.vcd"),postdelay=0.000,next=nil,char="glados"}
	--EndLevel12B
		...
		SceneTable["mp_coop_catapult_wall_introEndLevel12B01"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH12.vcd"),postdelay=0.3,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--EndLevel12O
		--Orange
		...
		SceneTable["mp_coop_catapult_wall_introEndLevel12O02"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_ONEPLAYER37.vcd"),postdelay=0.2,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--facepalmreply
		--Stop it!
		...
		SceneTable["mp_coop_catapult_wall_introfacepalmreply02"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt11.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_catapult_wall_introdeath
		--Your failure brings back such wonderful memories.
		SceneTable["mp_coop_catapult_wall_intromp_coop_catapult_wall_introdeath00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_catapult_wall_introdeath01.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2.5,skipifbusy=1}
	--mp_coop_catapult_wall_introstart
		...
		--That isn't science.
		SceneTable["mp_coop_catapult_wall_intromp_coop_catapult_wall_introstart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_catapult_wall_intro04.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0}
	--mp_coop_wall_introend
		...
		SceneTable["mp_coop_catapult_wall_intromp_coop_wall_introend03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_catapult_wall_intro06.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00,fireatstart=true}},predelay=0.5}
--mp_coop_wall_block                      
	--EndLevel05
		...
		--Please continue into the next test chamber.
		SceneTable["mp_coop_wall_blockEndLevel0502"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH15.vcd"),postdelay=0.000,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_wall_blockdeath
		--Your failing gives me no new data, it just delays the inevitable.
		SceneTable["mp_coop_wall_blockmp_coop_wall_blockdeath00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_blockdeath01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_wall_blockend
		...
		SceneTable["mp_coop_wall_blockmp_coop_wall_blockend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_block03.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_wall_blockend2
		...
		SceneTable["mp_coop_wall_blockmp_coop_wall_blockend202"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_block04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00,fireatstart=true}}}
	--mp_coop_wall_blockstart
		...
		SceneTable["mp_coop_wall_blockmp_coop_wall_blockstart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_block02.vcd"),postdelay=0.00,next=nil,char="glados",predelay=5}
--mp_coop_catapult_2                      
	--mp_coop_catapult_2end
		...
		SceneTable["mp_coop_catapult_2mp_coop_catapult_2end02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_catch03.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00,fireatstart=true}},predelay=1}
	--mp_coop_catapult_2start
		...
		SceneTable["mp_coop_catapult_2mp_coop_catapult_2start00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_catapult_201.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_turret_walls                    
	--mp_coop_turret_wallsdeath1
		--Just stop it already.
		SceneTable["mp_coop_turret_wallsmp_coop_turret_wallsdeath100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death01.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_turret_wallsdeath2
		--And that makes 10.
		SceneTable["mp_coop_turret_wallsmp_coop_turret_wallsdeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death04.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_turret_wallsdeath3
		--You really don't need to keep failing.
		SceneTable["mp_coop_turret_wallsmp_coop_turret_wallsdeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death05.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_turret_wallsend
		...
		SceneTable["mp_coop_turret_wallsmp_coop_turret_wallsend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_turret_walls04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_turret_wallsend2
		...
		SceneTable["mp_coop_turret_wallsmp_coop_turret_wallsend200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_turret_wall01.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_turret_wallsstart
		...
		SceneTable["mp_coop_turret_wallsmp_coop_turret_wallsstart00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_catapult_2.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_turret_ball                     
	--mp_coop_turret_balldeath1
		--If I made these tests any easier, they wouldn't be tests.
		SceneTable["mp_coop_turret_ballmp_coop_turret_balldeath100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death08.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_turret_balldeath2
		--Yay, Orange is back.  Testing can continue.
		SceneTable["mp_coop_turret_ballmp_coop_turret_balldeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death10.vcd"),postdelay=0.00,next=nil,char="glados",predelay=3,skipifbusy=1}
	--mp_coop_turret_balldeath3
		--Yay, Blue is back.  Testing can continue.
		SceneTable["mp_coop_turret_ballmp_coop_turret_balldeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death11.vcd"),postdelay=0.00,next=nil,char="glados",predelay=3,skipifbusy=1}
	--mp_coop_turret_balldeath4
		--Did you know, the reassembly machine has other things it could be reassembling?
		SceneTable["mp_coop_turret_ballmp_coop_turret_balldeath400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death16.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_turret_ballend
		...
		SceneTable["mp_coop_turret_ballmp_coop_turret_ballend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_turret_ball02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_turret_ballstart
		...
		SceneTable["mp_coop_turret_ballmp_coop_turret_ballstart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_obstacle03_alt.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_wall_5                          
	--mp_coop_wall_5end
		...
		--Blah.
		SceneTable["mp_coop_wall_5mp_coop_wall_5end11"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TEST_CHAMBER_BOTH19.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true}
	--mp_coop_wall_5security01
		--Today's Security Code is: 5,33,41,18
		SceneTable["mp_coop_wall_5mp_coop_wall_5security0100"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_coop_wall_5security01.vcd"),postdelay=0.00,next=nil,char="announcer",fires={{entity="@relay_explode_bots_transition",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_wall_5security02
		--Today's Security Code is: 5,33,41,18
		SceneTable["mp_coop_wall_5mp_coop_wall_5security0200"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_coop_wall_5security02.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--mp_coop_wall_5start
		...
		--For safety.
		SceneTable["mp_coop_wall_5mp_coop_wall_5start04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_504.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.25}
	--teamhugreply
		--Just stop flailing around like an incompetent.
		SceneTable["mp_coop_wall_5teamhugreply00"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt15.vcd"),postdelay=0.00,next=nil,char="glados",predelay=1.5}
--mp_coop_tbeam_redirect                  
	--mp_coop_tbeam_redirectbbehind
		--Blue, its not nice to make fun of Orange like that.
		SceneTable["mp_coop_tbeam_redirectmp_coop_tbeam_redirectbbehind00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge01.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_redirectdeath
		...
		SceneTable["mp_coop_tbeam_redirectmp_coop_tbeam_redirectdeath02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge_misc06.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,skipifbusy=1}
	--mp_coop_tbeam_redirectdeath2
		...
		SceneTable["mp_coop_tbeam_redirectmp_coop_tbeam_redirectdeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge_misc16.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_redirectdeath3
		--Watching you try to sabotage one other, I'm amazed you're still on friendly terms.
		SceneTable["mp_coop_tbeam_redirectmp_coop_tbeam_redirectdeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge_misc11.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_redirectendsc
		...
		SceneTable["mp_coop_tbeam_redirectmp_coop_tbeam_redirectendsc00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge_misc07.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_tbeam_redirectobehind
		--Orange, its not nice to make fun of Blue like that.
		SceneTable["mp_coop_tbeam_redirectmp_coop_tbeam_redirectobehind00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge02.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_redirectstart
		...
		SceneTable["mp_coop_tbeam_redirectmp_coop_tbeam_redirectstart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge36.vcd"),postdelay=0.00,next=nil,char="glados",predelay=1}
--mp_coop_tbeam_drill                     
	--mp_coop_tbeam_drilldeathblue
		--You were right, Orange. Blue was dumb enough to fall for your trap.
		SceneTable["mp_coop_tbeam_drillmp_coop_tbeam_drilldeathblue00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfugedeath_blue01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_drilldeathorange
		--Blue, that transpired just as you said it would.
		SceneTable["mp_coop_tbeam_drillmp_coop_tbeam_drilldeathorange00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfugedeath_orange02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_drillend
		...
		SceneTable["mp_coop_tbeam_drillmp_coop_tbeam_drillend02"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_PRIVATETALK_MIX04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_tbeam_drillstartsc
		...
		SceneTable["mp_coop_tbeam_drillmp_coop_tbeam_drillstartsc01"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge_misc14.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_tbeam_catch_grind_1             
	--mp_coop_tbeam_catch_grind_1start
		...
		SceneTable["mp_coop_tbeam_catch_grind_1mp_coop_tbeam_catch_grind_1start02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge17.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--trickfirereply
		--Just stop it already.
		...
		SceneTable["mp_coop_tbeam_catch_grind_1trickfirereply03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_catch_grind_1taunt04.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}},predelay=0.5}
--mp_coop_tbeam_laser_1                   
	--mp_coop_tbeam_laser_1death1
		--That worked just like you said it would, Blue.
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1death100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death22.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_laser_1death2
		--Orange, your plan is working perfectly.
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1death200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death23.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_laser_1death3
		--Blue, why did you do that to Orange?
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1death300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death24.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_laser_1end
		...
		--Still. That would have been exciting.
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1end02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_catchalt02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00,fireatstart=true}},predelay=1}
	--mp_coop_tbeam_laser_1end2
		--While teamwork is needed to complete these tests, I am not sure I trust the two of you together.
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1end200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge39.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}},predelay=0}
	--mp_coop_tbeam_laser_1startb
		...
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1startb02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge24.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_laser_1starto
		...
		SceneTable["mp_coop_tbeam_laser_1mp_coop_tbeam_laser_1starto02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge26.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_tbeam_polarity                  
	--mp_coop_tbeam_drillendb
		...
		SceneTable["mp_coop_tbeam_polaritymp_coop_tbeam_drillendb02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge14.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_tbeam_drillendo
		...
		--I trust you.  You are my favorite cooperative testing subject.
		SceneTable["mp_coop_tbeam_polaritymp_coop_tbeam_drillendo02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge14.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_tbeam_drillstartb
		--Orange, how well do you really know Blue?  Do you trust Blue?
		SceneTable["mp_coop_tbeam_polaritymp_coop_tbeam_drillstartb00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge11.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_drillstarto
		...
		SceneTable["mp_coop_tbeam_polaritymp_coop_tbeam_drillstarto00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge10.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_polaritydeathblue
		--Orange, that transpired just as you said it would.
		SceneTable["mp_coop_tbeam_polaritymp_coop_tbeam_polaritydeathblue00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfugedeath_blue02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_polaritydeathorange
		--I agree, Blue. That was entertaining.
		SceneTable["mp_coop_tbeam_polaritymp_coop_tbeam_polaritydeathorange00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfugedeath_orange03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
--mp_coop_tbeam_polarity2                 
	--mp_coop_tbeam_polarity2 whisperb
		...
		SceneTable["mp_coop_tbeam_polarity2mp_coop_tbeam_polarity2 whisperb03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge09.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_polarity2 whispero
		...
		SceneTable["mp_coop_tbeam_polarity2mp_coop_tbeam_polarity2 whispero04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge06.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_polarity2endscb
		...
		SceneTable["mp_coop_tbeam_polarity2mp_coop_tbeam_polarity2endscb02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge47.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_tbeam_polarity2endsco
		...
		SceneTable["mp_coop_tbeam_polarity2mp_coop_tbeam_polarity2endsco02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfuge45.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_tbeam_polarity2startb
		...
		SceneTable["mp_coop_tbeam_polarity2mp_coop_tbeam_polarity2startb02"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TALK_AT_ONCE11.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_polarity2starto
		...
		SceneTable["mp_coop_tbeam_polarity2mp_coop_tbeam_polarity2starto02"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_TALK_AT_ONCE12.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_tbeam_polarity3                 
	--mp_coop_tbeam_polarity3 deathblue1
		--I agree, Orange. That was entertaining.
		SceneTable["mp_coop_tbeam_polarity3mp_coop_tbeam_polarity3 deathblue100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfugedeath_blue03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_polarity3 deathblue2
		--Yes Orange, Blue did act like a fool just now.
		SceneTable["mp_coop_tbeam_polarity3mp_coop_tbeam_polarity3 deathblue200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfugedeath_blue04.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_polarity3 deathorange1
		--Yes, I know you did that, Blue. Don't look so proud.
		SceneTable["mp_coop_tbeam_polarity3mp_coop_tbeam_polarity3 deathorange100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfugedeath_orange06.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_polarity3 deathorange2
		--Blue, being the last one standing is not the goal.
		SceneTable["mp_coop_tbeam_polarity3mp_coop_tbeam_polarity3 deathorange200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_subterfugedeath_orange08.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_tbeam_polarity3end
		...
		SceneTable["mp_coop_tbeam_polarity3mp_coop_tbeam_polarity3end02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_polarity3_17.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}},predelay=1}
	--mp_coop_tbeam_polarity3start
		...
		SceneTable["mp_coop_tbeam_polarity3mp_coop_tbeam_polarity3start03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_polarity3_06.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.5}
--mp_coop_tbeam_maze                      
	--mp_coop_tbeam_mazeend
		...
		SceneTable["mp_coop_tbeam_mazemp_coop_tbeam_mazeend02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_maze03.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00,fireatstart=true}}}
	--mp_coop_tbeam_mazestart
		...
		SceneTable["mp_coop_tbeam_mazemp_coop_tbeam_mazestart00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_maze01.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_tbeam_mazestuck
		--While I should have left both of you trapped there forever, I do need you for something else.
		SceneTable["mp_coop_tbeam_mazemp_coop_tbeam_mazestuck00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_maze05.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2.5}
--mp_coop_tbeam_end                       
	--mp_coop_tbeam_endend
		...
		--Excellent.
		SceneTable["mp_coop_tbeam_endmp_coop_tbeam_endend04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_wall_5end01.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_explode_bots_transition",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_tbeam_endstart
		...
		--Oh those clerks.
		SceneTable["mp_coop_tbeam_endmp_coop_tbeam_endstart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_end02.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.85}
	--Tbeam_enddeath1
		--Did you think the electrical switch was down there?
		SceneTable["mp_coop_tbeam_endTbeam_enddeath100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_end11.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--Tbeam_enddeath2
		--You may want to try and avoid those turrets.
		SceneTable["mp_coop_tbeam_endTbeam_enddeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_end12.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--Tbeam_enddeath3
		--You are having so much trouble navigating this space; I wish I could say I created this test.
		SceneTable["mp_coop_tbeam_endTbeam_enddeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_end15.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--Tbeam_enddeath4
		--You two aren't lost are you?
		SceneTable["mp_coop_tbeam_endTbeam_enddeath400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_end14.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--Tbeam_enddeath5
		--At this rate, our best hope is for the fuel cell to meltdown in 2 million years and hope the explosion powers the system.
		SceneTable["mp_coop_tbeam_endTbeam_enddeath500"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_tbeam_end13.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
--mp_coop_paint_come_along                
	--mp_coop_humanresourcedeath1
		--Now, you are just wasting my time.
		SceneTable["mp_coop_paint_come_alongmp_coop_humanresourcedeath100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_humanresourcedeath01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2,skipifbusy=1}
	--mp_coop_humanresourcedeath3
		--I am not sure how I can make these tests any easier for you.
		SceneTable["mp_coop_paint_come_alongmp_coop_humanresourcedeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_humanresourcedeath03.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_humanresourcedeath4
		--If you can't complete these tests, we will never free the humans!
		SceneTable["mp_coop_paint_come_alongmp_coop_humanresourcedeath400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_humanresourcedeath04.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_humanresourcedeath5
		--If you can't complete this course, those humans will die. Do you want that?
		SceneTable["mp_coop_paint_come_alongmp_coop_humanresourcedeath500"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_humanresourcedeath07.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_humanresourcedeath6
		--If you can't complete this course, those humans will die. Do you want that in your memory banks?
		SceneTable["mp_coop_paint_come_alongmp_coop_humanresourcedeath600"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_humanresourcedeath08.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_paint_come_alongend
		...
		SceneTable["mp_coop_paint_come_alongmp_coop_paint_come_alongend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_come_along11.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_paint_come_alongstart
		...
		SceneTable["mp_coop_paint_come_alongmp_coop_paint_come_alongstart00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_come_along10.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_paint_redirect                  
	--mp_coop_paint_redirectdeath2
		--This close and that's what you do?
		SceneTable["mp_coop_paint_redirectmp_coop_paint_redirectdeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro65.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_paint_redirectdeath3
		--You are making this harder than it needs to be.
		SceneTable["mp_coop_paint_redirectmp_coop_paint_redirectdeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro74.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_paint_redirectend
		...
		SceneTable["mp_coop_paint_redirectmp_coop_paint_redirectend02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_redirect08.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_paint_redirectstart
		...
		SceneTable["mp_coop_paint_redirectmp_coop_paint_redirectstart03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_redirect06.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_paint_bridge                    
	--mp_coop_humanresourcedeath2
		--Your failing does not make this science.
		SceneTable["mp_coop_paint_bridgemp_coop_humanresourcedeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_humanresourcedeath02.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_humanresourcedeath2a
		...
		SceneTable["mp_coop_paint_bridgemp_coop_humanresourcedeath2a02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro67.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_bridgedeath
		...
		SceneTable["mp_coop_paint_bridgemp_coop_paint_bridgedeath02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_bridgedeath02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_paint_bridgenodeath
		...
		SceneTable["mp_coop_paint_bridgemp_coop_paint_bridgenodeath02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_bridgenodeath02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_paint_bridgestart
		...
		SceneTable["mp_coop_paint_bridgemp_coop_paint_bridgestart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_bridge02.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_paint_walljumps                 
	--mp_coop_paint_walljumpsend
		...
		SceneTable["mp_coop_paint_walljumpsmp_coop_paint_walljumpsend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_walljumps02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_paint_walljumpsstart
		...
		SceneTable["mp_coop_paint_walljumpsmp_coop_paint_walljumpsstart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_walljumps04.vcd"),postdelay=0.00,next=nil,char="glados",predelay=1}
--mp_coop_paint_speed_fling               
	--mp_coop_paint_speed_fling death
		--This close and you are going to fail me?
		SceneTable["mp_coop_paint_speed_flingmp_coop_paint_speed_fling death00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro71.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_paint_speed_flingend
		...
		SceneTable["mp_coop_paint_speed_flingmp_coop_paint_speed_flingend02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_fling03.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_paint_speed_flingstart
		...
		SceneTable["mp_coop_paint_speed_flingmp_coop_paint_speed_flingstart00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_fling01.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_paint_red_racer                 
	--mp_coop_paint_red_racerdeath1
		--Did you think that would be funny?
		SceneTable["mp_coop_paint_red_racermp_coop_paint_red_racerdeath100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death17.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_paint_red_racerdeath2
		--Are you testing me?
		SceneTable["mp_coop_paint_red_racermp_coop_paint_red_racerdeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death12.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_paint_red_racerdeath3
		--If at first you don't succeed, fail 5 more times.
		SceneTable["mp_coop_paint_red_racermp_coop_paint_red_racerdeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death06.vcd"),postdelay=0.00,next=nil,char="glados",predelay=2,skipifbusy=1}
	--mp_coop_paint_red_racerend
		--We are only two  tests away from reaching the humans, are you as excited as I am?
		SceneTable["mp_coop_paint_red_racermp_coop_paint_red_racerend00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_red_racer02.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
	--mp_coop_paint_red_racerstart
		...
		SceneTable["mp_coop_paint_red_racermp_coop_paint_red_racerstart00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_red_racer01.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_paint_speed_catch               
	--mp_coop_paint_speed_catchend
		...
		SceneTable["mp_coop_paint_speed_catchmp_coop_paint_speed_catchend03"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_catch08.vcd"),postdelay=0.00,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}},predelay=0.5}
	--mp_coop_paint_speed_catchstart
		...
		SceneTable["mp_coop_paint_speed_catchmp_coop_paint_speed_catchstart02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_speed_catch05.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_paint_longjump_intro            
	--mp_coop_paint_longjump_introdeath1
		--Stop failing, you need to find the vault door.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introdeath100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro69.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_paint_longjump_introdeath2
		--Stop doing that! All you need to do is open the Vault door!
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introdeath200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro70.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_paint_longjump_introdeath3
		--I'm starting to think you don't want to rescue the humans.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introdeath300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro75.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_paint_longjump_introdeath4
		--This close and you are going to fail me?
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introdeath400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro72.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=2.5,skipifbusy=1}
	--mp_coop_paint_longjump_introend1
		--Something is wrong, this door should be opening.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro64.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend10
		--You can't give up now.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend1000"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro58.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend11
		--What about that camera?
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend1100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro59.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend12
		--We're so close, you can't fail now!
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend1200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro60.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend2
		--This lock requires humans.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro03.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend3
		--The locking mechanism can tell you aren't humans.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro04.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend4
		--Do something only a human would do.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro05.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend5
		--Try one of those childish gestures.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend500"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro06.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend6
		--You both need to do something.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend600"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro45.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend7
		--The lock is looking for two humans.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend700"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro46.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend8
		--Try something.
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend800"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro53.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introend9
		--Is that camera is hooked into the lock?
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introend900"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro54.vcd"),postdelay=0.00,next=nil,char="glados",skipifbusy=1}
	--mp_coop_paint_longjump_introendx
		--You did it!
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introendx01"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro08.vcd"),postdelay=0.00,next=nil,char="glados",predelay=1}
	--mp_coop_paint_longjump_introstart
		...
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introstart00"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro44.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_paint_longjump_introTauntBlue
		...
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introTauntBlue02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro52.vcd"),postdelay=0.00,next=nil,char="glados"}
	--mp_coop_paint_longjump_introTauntOrange
		...
		SceneTable["mp_coop_paint_longjump_intromp_coop_paint_longjump_introTauntOrange02"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_longjump_intro51.vcd"),postdelay=0.00,next=nil,char="glados"}
--mp_coop_lobby                           
	--coop_hub_return1
		...
		SceneTable["mp_coop_lobbycoop_hub_return100"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_announcer_hub01.vcd"),postdelay=0.00,next=nil,char="announcer",talkover=true,predelay=3}
	--coop_hub_return2
		--Warning! Warning! All testing courses are currently available.
		SceneTable["mp_coop_lobbycoop_hub_return200"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_announcer_hub02.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--coop_hub_return3
		...
		SceneTable["mp_coop_lobbycoop_hub_return300"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_announcer_hub03.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--coop_hub_track01
		...
		SceneTable["mp_coop_lobbycoop_hub_track0104"] = {vcd=CreateSceneEntity("scenes/npc/glados/coop_hub_track16.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_hub_track02
		--Stop it!
		...
		SceneTable["mp_coop_lobbycoop_hub_track0204"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_artifactone_hub08.vcd"),postdelay=0.00,next=nil,char="glados",predelay=0.2}
	--coop_hub_track03
		--I don't know what you think you are doing, but I don't like it.  I want you to stop.
		...
		SceneTable["mp_coop_lobbycoop_hub_track0303"] = {vcd=CreateSceneEntity("scenes/npc/glados/coop_hub_track11.vcd"),postdelay=0.00,next=nil,char="glados"}
	--coop_hub_track04
		...
		SceneTable["mp_coop_lobbycoop_hub_track0405"] = {vcd=CreateSceneEntity("scenes/npc/glados/hub04_05.vcd"),postdelay=0.00,next=nil,char="glados",predelay=1}
	--coop_hub_track05
		...
		SceneTable["mp_coop_lobbycoop_hub_track0506"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_paint_come_along06.vcd"),postdelay=0.00,next=nil,char="glados",predelay=1}
	--coop_hub_trackdeath01
		--I know you like to think the reassembly machine is at your beck and call, but he has a life you know.  He's not your slave.
		SceneTable["mp_coop_lobbycoop_hub_trackdeath0100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_coop_rat_mazedeath04.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,skipifbusy=1}
	--coop_hub_trackdeath02
		--How can you fail at this?  It isn't even a test.
		SceneTable["mp_coop_lobbycoop_hub_trackdeath0200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death18.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,skipifbusy=1}
	--coop_hub_trackdeath03
		--I hope that was some kind of joke.
		SceneTable["mp_coop_lobbycoop_hub_trackdeath0300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death19.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,skipifbusy=1}
	--coop_hub_trackdeath04
		--I honestly never thought we would need to track how many times died in the hub.
		SceneTable["mp_coop_lobbycoop_hub_trackdeath0400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death20.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,skipifbusy=1}
	--coop_hub_trackdeath05
		--And here I thought this room was dangerously unlethal.
		SceneTable["mp_coop_lobbycoop_hub_trackdeath0500"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_death21.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,skipifbusy=1}
	--hub_return11
		--Welcome back to the Computer Intelligence Training and Enrichment Center Human Test Subject Research Center.
		SceneTable["mp_coop_lobbyhub_return1100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hub_return02a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return12
		--Hello again, did you know these are the only set of tests available to you� you are going to need to select them again.
		SceneTable["mp_coop_lobbyhub_return1200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn03.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return13
		--I guess quitting that course together is a sign of teamwork.
		SceneTable["mp_coop_lobbyhub_return1300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn07.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return14
		--The way you two just gave up on that test together shows you are really working as a team.
		SceneTable["mp_coop_lobbyhub_return1400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn08.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return21
		--Welcome back to the hub, did you fail at selecting the correct course?
		SceneTable["mp_coop_lobbyhub_return2100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hub_return05a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return22
		--Welcome back to the Computer Intelligence Training and Enrichment Center Human Test Subject Research Center. [laughs]
		SceneTable["mp_coop_lobbyhub_return2200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hub_return01a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return23
		--Look who's back, were you scared to continue those tests?
		SceneTable["mp_coop_lobbyhub_return2300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn01.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return24
		--If at first you don't succeed, quit and try another course.
		SceneTable["mp_coop_lobbyhub_return2400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn04.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return31
		--Welcome back, testing is available.
		SceneTable["mp_coop_lobbyhub_return3100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hub_return03a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return32
		--Was that course too difficult?
		SceneTable["mp_coop_lobbyhub_return3200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hub_return06a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return33
		--Back again?  Maybe you can just stay and live here in the hub?
		SceneTable["mp_coop_lobbyhub_return3300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn05.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return41
		--Blue, I wouldn't have trusted Orange in that course either.
		SceneTable["mp_coop_lobbyhub_return4100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn11.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return42
		--Look who's back, were you scared to continue those tests?
		SceneTable["mp_coop_lobbyhub_return4200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn02.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return43
		--Back again?  Maybe you can just stay and live here.
		SceneTable["mp_coop_lobbyhub_return4300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn06.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return51
		--Are you scared to save those humans?
		SceneTable["mp_coop_lobbyhub_return5100"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn09.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return52
		--Are you scared to save those humans?
		SceneTable["mp_coop_lobbyhub_return5200"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hubreturn10.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_return53
		--Welcome back quitters, maybe you can find another course for you to fail.
		SceneTable["mp_coop_lobbyhub_return5300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_hub_return04a.vcd"),postdelay=0.00,next=nil,char="glados"}
	--hub_returnall1
		--Welcome to the Computer Intelligence Training and Enrichment Center Human Test Subject Research Center.  You have unlocked all available courses.
		SceneTable["mp_coop_lobbyhub_returnall100"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_hub_return01.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--hub_returnall2
		--Warning! All testing courses are currently available.
		SceneTable["mp_coop_lobbyhub_returnall200"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_hub_return02.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--hub_returnall3
		--Congratulations on successfully returning to the central hub room.  From here you can select all previously completed courses.
		SceneTable["mp_coop_lobbyhub_returnall300"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_hub_return03.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--hub_returnall4
		...
		SceneTable["mp_coop_lobbyhub_returnall400"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_hub_return04.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--hub_returnall5
		--Welcome back to the central hub. All test courses are available. You may redundantly solve the courses at your leisure.
		SceneTable["mp_coop_lobbyhub_returnall500"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_hub_return05.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--hub_returnall6
		...
		SceneTable["mp_coop_lobbyhub_returnall600"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_hub_return06.vcd"),postdelay=0.00,next=nil,char="announcer"}
	--hub_returnall7
		...
		SceneTable["mp_coop_lobbyhub_returnall700"] = {vcd=CreateSceneEntity("scenes/npc/announcer/mp_hub_return07.vcd"),postdelay=0.00,next=nil,char="announcer"}
--mp_coop_lobby2                          
--taunts                                  
	--tauntstory
		--Stop it!
		...
		SceneTable["tauntstauntstory04"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_humanresources04.vcd"),postdelay=0.00,next=nil,char="glados"}
	--taunt_big_wave1
		--Yes, I see you.
		SceneTable["tauntstaunt_big_wave100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_big_wave05.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_big_wave2
		--I'm seriously not paying atten-- STOP THAT RIGHT NOW!
		SceneTable["tauntstaunt_big_wave200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_big_wave06.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_big_wave3
		--Keep it up and your arm will get stuck like that.
		SceneTable["tauntstaunt_big_wave300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_big_wave01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_big_wave4
		--Hellllooo, imbecile.
		SceneTable["tauntstaunt_big_wave400"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_big_wave02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_big_wave5
		--Yes, I see you waving.
		SceneTable["tauntstaunt_big_wave500"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_big_wave07.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_cannonball1
		--Good job jumping. You must be very proud.
		SceneTable["tauntstaunt_cannonball100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_cannonball01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_cannonball2
		--I hardly think you're even trying with these gestures anymore.
		SceneTable["tauntstaunt_cannonball200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_cannonball02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_cannonball3
		--Did something happen? [yawn] I wasn't watching.
		SceneTable["tauntstaunt_cannonball300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_cannonball03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_highfive1
		--That is not part of the test.
		SceneTable["tauntstaunt_highfive100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_highfive01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_highfive2
		--Slapping hands. That accomplishes something.
		SceneTable["tauntstaunt_highfive200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_highfive03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_highfive3
		--If you're going to hit each other, at least aim for the head.
		SceneTable["tauntstaunt_highfive300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_highfive04.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_highfive4
		--You're doing a great job of disappointing me.
		SceneTable["tauntstaunt_highfive400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_taunts03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_laugh1
		--You know what makes me laugh? The thought of you cutting that out.
		SceneTable["tauntstaunt_laugh100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_laugh02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_laugh2
		--Yes. Let's all laugh. Ha. Ha. Ha.
		SceneTable["tauntstaunt_laugh200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_laugh05.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_laugh3
		--Ha ha ha ha ha, good one.
		SceneTable["tauntstaunt_laugh300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_laugh03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_laugh4
		--You know what makes me laugh? The thought of you stopping that.
		SceneTable["tauntstaunt_laugh400"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_laugh01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_laugh5
		--Ha ha ha ha ha. Did I tell you the one about the turned-off reassembly machine?
		SceneTable["tauntstaunt_laugh500"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_laugh06.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_laugh6
		--Is it the lack of mirrors in test chambers that encourages you to do this?
		SceneTable["tauntstaunt_laugh600"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_taunts05.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_robot_arm_ripple1
		--Are you broken? It looks like you're malfunctioning.
		SceneTable["tauntstaunt_robot_arm_ripple100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_robot_arm_ripple01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_robot_arm_ripple2
		--Really, not even humans do that anymore.
		SceneTable["tauntstaunt_robot_arm_ripple200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_robot_arm_ripple02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_robot_arm_ripple3
		--You're no longer bothering me. You're only hurting my impression of you.
		SceneTable["tauntstaunt_robot_arm_ripple300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_robot_arm_ripple03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_robot_arm_ripple4
		--Look at you. Dancing.
		SceneTable["tauntstaunt_robot_arm_ripple400"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_robot_arm_ripple04.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_robot_arm_ripple5
		--If you were wondering how could you annoy me without failing a test.  Now you know.
		SceneTable["tauntstaunt_robot_arm_ripple500"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_robot_arm_ripple05.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_robot_arm_ripple6
		--Oh great, dancing again.
		SceneTable["tauntstaunt_robot_arm_ripple600"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_robot_arm_ripple06.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_robot_arm_ripple7
		--DANCING is NOT SCIENCE!
		SceneTable["tauntstaunt_robot_arm_ripple700"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_taunts06.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_rockpaperscissors1
		--I defy you to tell me there's a purpose to what you're doing.
		SceneTable["tauntstaunt_rockpaperscissors100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_rockpaperscissors01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_rockpaperscissors3
		--Come on. You were raised better than that.
		SceneTable["tauntstaunt_rockpaperscissors300"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_taunts01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_small_wave1
		--Yes, I see you, and no, I don't care.
		SceneTable["tauntstaunt_small_wave100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_small_wave01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_small_wave2
		--Yes? Something you need?
		SceneTable["tauntstaunt_small_wave200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_small_wave02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_small_wave3
		--You do know I can't wave back right?
		SceneTable["tauntstaunt_small_wave300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_small_wave03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_small_wave4
		--Stop with the waves.
		SceneTable["tauntstaunt_small_wave400"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_small_wave04.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_small_wave_portalgun1
		--Are you trying to get my attention? I am very busy, you know.
		SceneTable["tauntstaunt_small_wave_portalgun100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_small_wave_portalgun01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_small_wave_portalgun2
		--Not paying attennnntion...
		SceneTable["tauntstaunt_small_wave_portalgun200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_small_wave_portalgun02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_small_wave_portalgun3
		--Are you expecting applause?
		SceneTable["tauntstaunt_small_wave_portalgun300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_small_wave_portalgun03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_somersault1
		--I give you a score of 3.4 for style and 10 for being annoying.
		SceneTable["tauntstaunt_somersault100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_somersault01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_somersault2
		--A somersault is just falling over in style. Congratulations on being clumsy.
		SceneTable["tauntstaunt_somersault200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_somersault02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_somersault3
		--If I stop watching, I'm sure you'll get bored of this.
		SceneTable["tauntstaunt_somersault300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_somersault03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_splits1
		--All right. I'm officially no longer paying attention to you.
		SceneTable["tauntstaunt_splits100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_splits01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_splits2
		--You're the type of show-off who only shows off really stupid things.
		SceneTable["tauntstaunt_splits200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_splits03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamhug1
		--It appears you're developing human traits. The worst human traits.
		SceneTable["tauntstaunt_teamhug100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_teamhug01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamhug2
		--Be careful. Hugging can lead to... well, me disassembling you forever.
		SceneTable["tauntstaunt_teamhug200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_teamhug02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamhug3
		--Stop touching each other!
		SceneTable["tauntstaunt_teamhug300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_teamhug03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamhug4
		--Your eagerness to test pleases me. Your inane gesturing does not.
		SceneTable["tauntstaunt_teamhug400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_taunts04.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamtease1
		--Are you trying to impress me? What would impress me more is if you never did that again.
		SceneTable["tauntstaunt_teamtease100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_teamtease01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamtease2
		--I'll interpret that gesture to mean that you want me to become even more vindictive toward you.
		SceneTable["tauntstaunt_teamtease200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_teamtease02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamtease3
		--Orange, I certainly expected more from you.
		SceneTable["tauntstaunt_teamtease300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_teamtease03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamtease4
		--Blue, don't sink to Orange's level.
		SceneTable["tauntstaunt_teamtease400"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_teamtease04.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_teamtease5
		--Even humans, as stupid as they are, would say you look stupid when you do that.
		SceneTable["tauntstaunt_teamtease500"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_taunts02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_trickfire2
		--You really aren't getting tired of that, are you?
		SceneTable["tauntstaunt_trickfire200"] = {vcd=CreateSceneEntity("scenes/npc/glados/anti_taunt14.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_trickfire3
		--All right. I'm officially no longer paying attention to you.
		SceneTable["tauntstaunt_trickfire300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_splits02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_trickfire4
		--You're doing a great job of disappointing me.
		SceneTable["tauntstaunt_trickfire400"] = {vcd=CreateSceneEntity("scenes/npc/glados/mp_taunts03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_trickfire_handstand1
		--Now you're thinking with stupidity.
		SceneTable["tauntstaunt_trickfire_handstand100"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_trickfire_handstand01.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_trickfire_handstand2
		--Now you're just not thinking.
		SceneTable["tauntstaunt_trickfire_handstand200"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_trickfire_handstand02.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_trickfire_handstand3
		--Congratulations. You're upside down now.
		SceneTable["tauntstaunt_trickfire_handstand300"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_trickfire_handstand03.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_trickfire_handstand4
		--I'm starting to think giving you arms was a big mistake.
		SceneTable["tauntstaunt_trickfire_handstand400"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_trickfire_handstand05.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
	--taunt_trickfire_handstand5
		--You're going to hurt yourself doing that and then I will be ECSTATIC.
		SceneTable["tauntstaunt_trickfire_handstand500"] = {vcd=CreateSceneEntity("scenes/npc/glados/taunt_trickfire_handstand04.vcd"),postdelay=0.00,next=nil,char="glados",talkover=true,predelay=3,skipifbusy=1}
