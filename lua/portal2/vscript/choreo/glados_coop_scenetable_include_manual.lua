...
--		SceneTable["coop_score_blue05_02"] = {vcd=CreateSceneEntity("scenes/npc/glados/COOP_SCORING03.vcd"),postdelay=1.0,next=nil}		
		...
		SceneTable["coop_gesture_intro_pax02"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro02.vcd"),postdelay=0.5,next=nil}
		--PAX ATTAX
		
		

		
		SceneTable["coop_portal_ping_intro_orange_nag"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro15.vcd"),postdelay=0.5,next=nil}
		SceneTable["coop_portal_ping_intro_blue_nag"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro16.vcd"),postdelay=0.5,next=nil}
		
		SceneTable["coop_portal_ping_reminder01"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_intro17.vcd"),postdelay=0.5,next=nil}
...
--		SceneTable["coop_start_results_1_01"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_tubeone01.vcd"),postdelay=0.5,next="coop_start_results_1_02"}
		...
		--SceneTable["coop_start_results_1_04"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_tubeone04.vcd"),postdelay=0.5,next=nil,fireentity="@relay_enable_exit",fireinput="Trigger",firedelay=0.0}
		
		SceneTable["coop_start_results_2_01"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_tubetwo01.vcd"),postdelay=0.5,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
		...
		SceneTable["coop_start_results_3_02"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_tubethree02.vcd"),postdelay=0.5,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
		...
		SceneTable["coop_humansplanb_02"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_humansplanb02.vcd"),postdelay=0.5,next=nil,fireentity="relay_initiate_plan_B",fireinput="Trigger",firedelay=0.0}

		SceneTable["coop_radar_room_01"] = {vcd=CreateSceneEntity("scenes/npc/glados/coop/coop_radar_find_human_entry.vcd"),postdelay=0.5,next=nil}
		...
		SceneTable["coop_radar_room_07"] = {vcd=CreateSceneEntity("scenes/npc/glados/PreHub04.vcd"),postdelay=0.5,next=nil,fireentity="@relay_explode_bots_transition",fireinput="Trigger",firedelay=0.5}
		...
		SceneTable["coop_hub_first_05"] = {vcd=CreateSceneEntity("scenes/npc/glados/coop/coop_explain_make_human.vcd"),postdelay=0.5,next=nil,fireentity="relay_earn_first_gesture",fireinput="Trigger",firedelay=0.0}
		...
		SceneTable["coop_hub_first_08"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_hub_first_run07.vcd"),postdelay=0.5,next=nil}
		...
		SceneTable["coop_hub_artifact1_08"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_artifactone_hub08.vcd"),postdelay=1.5,next=nil}
		...
		SceneTable["coop_artifact1_02"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_artifactone02.vcd"),postdelay=0.5,next=nil,fireentity="@relay_see_artifact",fireinput="Trigger",firedelay=2.0}
		
		-- that's it, scan it
		SceneTable["coop_artifact1_03"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_artifactone03.vcd"),postdelay=0.5,next=nil,fireentity="@relay_make_artifact_glow",fireinput="Trigger",firedelay=0.0}
		...
		SceneTable["coop_artifact1_10"] = {vcd=CreateSceneEntity("scenes/npc/glados/PreHub04.vcd"),postdelay=0.5,next=nil,fireentity="@relay_explode_bots_transition",fireinput="Trigger",firedelay=0.5}
							
		SceneTable["botcoop_posthub_tube_zero"] = {vcd=CreateSceneEntity("scenes/npc/glados/coop/coop_posthub_tube_zero_temp.vcd"),postdelay=0.5,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
...
--		SceneTable["botcoop_posthub_tube_one03"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_posthub_tube_one03.vcd"),postdelay=0.5,next=nil,char="glados",fires=[{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}]}
		
		--botcoop_competition01
		SceneTable["botcoop_competition01"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_competition01.vcd"),postdelay=0.5,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
		--botcoop_competition10
		SceneTable["botcoop_competition10"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_competition10.vcd"),postdelay=0.5,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
		--botcoop_competition13
		SceneTable["botcoop_competition13"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_competition13.vcd"),postdelay=0.5,next=nil,char="glados",fires={{entity="@relay_enable_exit",input="Trigger",parameter="",delay=0.00}}}
		--botcoop_paxdemo01
		SceneTable["botcoop_paxdemo01"] = {vcd=CreateSceneEntity("scenes/npc/glados/botcoop_paxdemo01.vcd"),postdelay=0.5,next=nil}		
