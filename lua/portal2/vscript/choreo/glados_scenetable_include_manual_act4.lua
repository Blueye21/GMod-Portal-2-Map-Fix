...
Properties:
	The following properties are evaluated for EVERY vcd in  a scene:
		...
		[required] next 
				SceneTable index of next vcd in scene or nil for last vcd in scene.
		[required] char
	...
	Nag/Idle tags:
		-Every vcd in a nag/idle block should have "next" set to nil (unless they are part of a "nag chain" - see idleindex/idleunder below)
...
-- ======================================
	...
	SceneTableLookup[-4850] = "-4850_01" 	-- Surprise again! Another death trap.
		--If I'm honest, I'm sure you'll figure out some way to get past it, if I'm honest. Not na�ve. But, uh, just throwing this out there. What if you just let it kill you?
...
--				{entity="@glados",input="RunScriptCode",parameter="RecaptureProceed()",delay=3.8 },
        ...
        -- Alright, get moving.
         SceneTable["-4008_01"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_fire_lift02.vcd"),idlerepeat=true, postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idle=true,idleminsecs=10.0,idlemaxsecs=20.0,idlegroup="proceednag",idleorderingroup=1}
         SceneTable["-4008_02"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_fire_lift03.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="proceednag",idleorderingroup=2}
         SceneTable["-4008_03"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_paradox11.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="proceednag",idleorderingroup=3}
         SceneTable["-4008_04"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_leave_nags01.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="proceednag",idleorderingroup=4}
	...
	--[[	-- I do.
        ...
        -- Go on.
         SceneTable["-4021_01"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_sp_a4_intro_moat04.vcd"), postdelay=0.3,next=nil,char="wheatley",idleminsecs=6.0,idlemaxsecs=8.0,noDingOff=true,noDingOn=true,idle=true,idlegroup="test1hints",idleorderingroup=1}
		 SceneTable["-4021_02"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_first_test_solve_nags02.vcd"), postdelay=0.3,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idle=true,idlegroup="test1hints",idleorderingroup=2}
		 SceneTable["-4021_03"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_first_test_solve_nags03.vcd"),postdelay=3.4,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1hints",idleorderingroup=3}
         SceneTable["-4021_04"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags01.vcd"),postdelay=3.4,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1hints",idleorderingroup=4}
		 SceneTable["-4021_05"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags01.vcd"),postdelay=3.4,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1hints",idleorderingroup=5}
         SceneTable["-4021_06"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags02.vcd"),postdelay=3.4,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1hints",idleorderingroup=6}
		 SceneTable["-4021_07"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags03.vcd"),postdelay=3.4,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1hints",idleorderingroup=7}
		 SceneTable["-4021_08"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags04.vcd"),postdelay=0.0,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1hints",idleorderingroup=8}
		 
		-- ====================================== First Test Finish Nags
		 
		 -- Hold on.  You've still got to finish the test
		 SceneTable["-4022_01"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_sp_a4_intro_notdone01.vcd"), postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idle=true,idleminsecs=8.0,idlemaxsecs=12.0,idlegroup="test1finishhints",idleorderingroup=1}		 
         SceneTable["-4022_02"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_sp_a4_intro_notdone02.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1finishhints",idleorderingroup=2}
 		 SceneTable["-4022_03"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags06.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1finishhints",idleorderingroup=3}
         SceneTable["-4022_04"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_sp_a4_intro_notdone04.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1finishhints",idleorderingroup=4}
         SceneTable["-4022_05"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_misc_solve_nags07.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test1finishhints",idleorderingroup=5}
        ...
        SceneTable["-4019_01"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test01.vcd"),idlerepeat=true, postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idle=true,idleminsecs=6.0,idlemaxsecs=8.0,idlegroup="test2hints",idleorderingroup=1, queue = true,	queuecharacter = "wheatley"}
        SceneTable["-4019_02"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags02.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test2hints",idleorderingroup=2}
        SceneTable["-4019_03"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags03.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test2hints",idleorderingroup=3}
		SceneTable["-4019_04"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags04.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test2hints",idleorderingroup=4}
		SceneTable["-4019_05"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_a4_2nd_first_test_solve_nags05.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="test2hints",idleorderingroup=5}
...
-- ****************************************************************************************************
	...
	if curMapName=="sp_a4_finale4" then
        ...
        SceneTable["-4940_01"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags01.vcd"),idlerepeat=true, postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idle=true,idleminsecs=6.0,idlemaxsecs=8.0,idlegroup="stalemate_buttonnags",idleorderingroup=1}
        SceneTable["-4940_02"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags02.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="stalemate_buttonnags",idleorderingroup=2}
        SceneTable["-4940_03"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags03.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="stalemate_buttonnags",idleorderingroup=3}
		SceneTable["-4940_04"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags04.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="stalemate_buttonnags",idleorderingroup=4}
		SceneTable["-4940_05"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags05.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="stalemate_buttonnags",idleorderingroup=5}
		SceneTable["-4940_06"] = {vcd=CreateSceneEntity("scenes/npc/sphere03/bw_bb_buttonnags06.vcd"),postdelay=0.1,next=nil,char="wheatley",noDingOff=true,noDingOn=true,idlegroup="stalemate_buttonnags",idleorderingroup=6}
...
SceneTableLookup[-7300] = "-7300_01" 
	...
	if curMapName=="sp_a4_finale4" or curMapName=="core_test1" then
		...
		SceneTable["altwakeupthree14"] = {vcd=CreateSceneEntity("scenes/npc/announcer/bb_stalemate07.vcd"),postdelay=0.1,next=nil,char="bossannouncer",fires={{entity="stalemate_relay",input="trigger",parameter="",delay=3.0,fireatstart=true},{entity="@glados",input="runscriptcode",parameter="BBButtonNags2()",delay=0.0}},noDingOff=true,noDingOn=true}


		-- ====================================== "Space" Core01
		
		--Space space wanna go to space yes please space. Space space. Go to space.
		SceneTable["-7100_01"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble20.vcd"),idlerepeat=true, postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idle=true,idleminsecs=0.00,idlemaxsecs=0.08,idlegroup="core01_babble",idleorderingroup=1}
		--Ba! Ba! Ba ba ba! Space! Ba! Ba! Ba ba ba!
		SceneTable["-7100_02"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble24.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=2}
		--Oh. Play it cool. Play it cool. Here come the space cops.
		SceneTable["-7100_03"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble28.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=3}
		--Help me, space cops. Space cops, help.
		SceneTable["-7100_04"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble29.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=4}
		--Better buy a telescope. Wanna see me. Buy a telescope. Gonna be in space.
		SceneTable["-7100_05"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble33.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=5}
		--Space space wanna go to space
		SceneTable["-7100_06"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble67.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=6}
		--Orbit. Space orbit. In my spacesuit.
		SceneTable["-7100_07"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble58.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=7}
		--Oo. Oo. Oo. Lady. Oo. Lady. Oo. Let's go to space.
		SceneTable["-7100_08"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble105.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=8}
		--Gotta go to space. Lady. Lady.
		SceneTable["-7100_09"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble102.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=9}
		--Come here, space. I have a secret for you. No, come closer.
		SceneTable["-7100_10"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble62.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=10}
		--What's your favorite thing about space? Mine is space.
		SceneTable["-7100_11"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble05.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=11}
		--Space. Trial. Puttin' the system on trial. Guilty. Of being in space. Going to space jail.
		SceneTable["-7100_12"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble16.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=12}
		...
		SceneTable["-7100_13"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble19.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=13}
		--Space going to space can't wait.
		SceneTable["-7100_14"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble11.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=14}
		--Space...
		SceneTable["-7100_15"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble14.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=15}
		--Space space wanna go to space
		SceneTable["-7100_16"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble21.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=16}
		--Space space going to space oh boy
		SceneTable["-7100_17"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble22.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=17}
		--Going to space going there can't wait gotta go. Space. Going.
		SceneTable["-7100_18"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble31.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=18}
		--Space. Space.
		SceneTable["-7100_19"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble35.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=19}
		--I'm going to space.
		SceneTable["-7100_20"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble36.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=20}
		--Oh boy.
		SceneTable["-7100_21"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble37.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=21}
		--Yeah yeah okay okay.
		SceneTable["-7100_22"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble40.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=22}
		--Space. Space. Gonna go to space.
		SceneTable["-7100_23"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble42.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=23}
		--Space. Space. Go to space.
		SceneTable["-7100_24"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble43.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=24}
		--Yes. Please. Space.
		SceneTable["-7100_25"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble44.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=25}
		--Ba! Ba! Ba ba ba! Space!
		SceneTable["-7100_26"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble45.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=26}
		--Ba! Ba! Ba ba ba! Space!
		SceneTable["-7100_27"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble46.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=27}
		--Gonna be in space.
		SceneTable["-7100_28"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble47.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=28}
		--Hey.
		SceneTable["-7100_29"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble89.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=29}
		--Hey.
		SceneTable["-7100_30"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble90.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=30}
		--Hey.
		SceneTable["-7100_31"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble91.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=31}
		--Hey.
		SceneTable["-7100_32"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble92.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=32}
		--Hey.
		SceneTable["-7100_33"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble93.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=33}
		--Hey lady.
		SceneTable["-7100_34"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble94.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=34}
		--Lady.
		SceneTable["-7100_35"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble95.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=35}
		--Lady.
		SceneTable["-7100_36"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble99.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=36}
		--Hey lady.
		SceneTable["-7100_37"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb30.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=37}
		--Hey.
		SceneTable["-7100_38"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb31.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=38}
		--Lady.
		SceneTable["-7100_39"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb32.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=39}
		--Hey lady. Lady.
		SceneTable["-7100_40"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb33.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=40}
		--Hey.
		SceneTable["-7100_41"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb34.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=41}
		--Lady.
		SceneTable["-7100_42"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb35.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=42}
		--Space.
		SceneTable["-7100_43"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble48.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=43}
		--Space.
		SceneTable["-7100_44"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble49.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=44}
		--Ohhhh, space.
		SceneTable["-7100_45"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble50.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=45}
		--Wanna go to space. Space.
		SceneTable["-7100_46"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble51.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=46}
		--[humming]
		SceneTable["-7100_47"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble52.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=47}
		--Let's go to space. Let's go to space.
		SceneTable["-7100_48"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble53.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=48}
		--I love space. Love space.
		SceneTable["-7100_49"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble54.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=49}
		--Space...
		SceneTable["-7100_50"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble59.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=50}
		--Atmosphere. Black holes. Astronauts. Nebulas. Jupiter. The Big dipper.
		SceneTable["-7100_51"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble57.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=51}
		--Wanna go to -- wanna go to space
		SceneTable["-7100_52"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble68.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=52}
		--Space wanna go wanna go to space wanna go to space
		SceneTable["-7100_53"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble70.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=53}
		--I'm going to space.
		SceneTable["-7100_54"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble71.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=54}
		--Space!
		SceneTable["-7100_55"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble73.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=55}
		--Space!
		SceneTable["-7100_56"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble83.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=56}
		--Hey hey hey hey hey!
		SceneTable["-7100_57"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble88.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=57}
		--Space!
		SceneTable["-7100_58"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble98.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=58}
		--Space.
		SceneTable["-7100_59"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble100.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=59}
		--Ohhh, the Sun. I'm gonna meet the Sun. Oh no! What'll I say? "Hi! Hi, Sun!" Oh, boy!
		SceneTable["-7100_60"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble60.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=60}
		--Look, an eclipse! No. Don't look.
		SceneTable["-7100_61"] = {vcd=CreateSceneEntity("scenes/npc/core01/babble61.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=61}
		--Oh I know! I know I know I know I know I know - let's go to space!
		SceneTable["-7100_62"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb01.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=62}
		--Oooh! Ooh! Hi hi hi hi hi. Where we going? Where we going? Hey. Lady. Where we going? Where we going? Let's go to space!
		SceneTable["-7100_63"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb02.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=63}
		--Lady. I love space. I know! Spell it! S P... AACE. Space. Space.
		SceneTable["-7100_64"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb03.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=64}
		--I love space.
		SceneTable["-7100_65"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb04.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=65}
		--Hey lady. Lady. I'm the best. I'm the best at space.
		SceneTable["-7100_66"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb05.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=66}
		--Oh oh oh oh. Wait wait. Wait I know. I know. I know wait. Space.
		SceneTable["-7100_67"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb06.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=67}
		--Wait wait wait wait. I know I know I know. Lady wait. Wait. I know. Wait. Space.
		SceneTable["-7100_68"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb07.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=68}
		--Gotta go to space.
		SceneTable["-7100_69"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb08.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=69}
		--Gonna be in space.
		SceneTable["-7100_70"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb09.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=70}
		--Oh oh oh ohohohoh oh. Gotta go to space.
		SceneTable["-7100_71"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb10.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=71}
		--Space. Space. Space. Space. Comets. Stars. Galaxies. Orion.
		SceneTable["-7100_72"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb11.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=72}
		--Are we in space yet? What's the hold-up? Gotta go to space. Gotta go to SPACE.
		SceneTable["-7100_73"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb12.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=73}
		--Going to space.
		SceneTable["-7100_74"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb13.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=74}
		--I'm going. Going to space.
		SceneTable["-7100_75"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb14.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=75}
		--Love space. Need to go to space.
		SceneTable["-7100_76"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb15.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=76}
		--Space space space. Going. Going there. Okay. I love you, space.
		SceneTable["-7100_77"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb16.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=77}
		--Space.
		SceneTable["-7100_78"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb17.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=78}
		--So much space. Need to see it all.
		SceneTable["-7100_79"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb18.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=79}
		...
		SceneTable["-7100_80"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb19.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=80}
		--Space Court. For people in space. Judge space sun presiding. Bam. Guilty. Of being in space. I'm in space.
		SceneTable["-7100_81"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb20.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=81}
		--Please go to space.
		SceneTable["-7100_82"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb21.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=82}
		--Space.
		SceneTable["-7100_83"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb22.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=83}
		--Wanna go to space.
		SceneTable["-7100_84"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb23.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=84}
		--(excited gasps)
		SceneTable["-7100_85"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb24.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=85}
		--Gotta go to space. Yeah. Gotta go to space.
		SceneTable["-7100_86"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb25.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=86}
		--Hmmm. Hmmmmmm. Hmm. Hmmmmm. Space!
		SceneTable["-7100_87"] = {vcd=CreateSceneEntity("scenes/npc/core01/babbleb26.vcd"),postdelay=0.01,next=nil,char="core01",noDingOff=true,noDingOn=true,idlegroup="core01_babble",idleorderingroup=87}

		
		-- ====================================== "Fact" Core02
		--[[
		SceneTable["-7200_01"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact01.vcd"),idlerepeat=true, postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idle=true,idleminsecs=1.0,idlemaxsecs=2.0,idlegroup="core02_fact",idleorderingroup=1}
		SceneTable["-7200_02"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact02.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=2}
		SceneTable["-7200_03"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact03.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=3}
		SceneTable["-7200_04"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact04.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=4}
		SceneTable["-7200_05"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact05.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=5}
		SceneTable["-7200_06"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact06.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=6}
		SceneTable["-7200_07"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact07.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=7}
		SceneTable["-7200_08"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact08.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=8}
		SceneTable["-7200_09"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact09.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=9}
		SceneTable["-7200_10"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact10.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=10}
		SceneTable["-7200_11"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact11.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=11}
		SceneTable["-7200_12"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact12.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=12}
		SceneTable["-7200_13"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact13.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=13}
		SceneTable["-7200_14"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact14.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=14}
		SceneTable["-7200_15"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact15.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=15}
		SceneTable["-7200_16"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact16.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=16}
		SceneTable["-7200_17"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact17.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=17}
		SceneTable["-7200_18"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact18.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=18}
		SceneTable["-7200_19"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact19.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=19}
		SceneTable["-7200_20"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact20.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=20}
		SceneTable["-7200_21"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact21.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=21}
		SceneTable["-7200_22"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact22.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=22}
		SceneTable["-7200_23"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact23.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=23}
		SceneTable["-7200_24"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact24.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=24}
		SceneTable["-7200_25"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact25.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=25}
		SceneTable["-7200_26"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact26.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=26}
		SceneTable["-7200_27"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact27.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=27}
		SceneTable["-7200_28"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact28.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=28}
		SceneTable["-7200_29"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact29.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=29}
		SceneTable["-7200_30"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact30.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=30}
		SceneTable["-7200_31"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact31.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=31}
		SceneTable["-7200_32"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact32.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=32}
		SceneTable["-7200_33"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact33.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=33}
		SceneTable["-7200_34"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact34.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=34}
		SceneTable["-7200_35"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact35.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=35}
		SceneTable["-7200_36"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact36.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=36}
		SceneTable["-7200_37"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact37.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=37}
		SceneTable["-7200_38"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact38.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=38}
		SceneTable["-7200_39"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact39.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=39}
		SceneTable["-7200_40"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact40.vcd"),postdelay=0.1,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_fact",idleorderingroup=40}
		]]
		
		
		--Dental floss has superb tensile strength.
		SceneTable["-7200_01"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact01.vcd"),idlerandom = true, postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idle=true,idleminsecs=0.5,idlemaxsecs=1.5,idlegroup="core02_babble",idleorderingroup=1}
		--The square root of rope is string.
		SceneTable["-7200_02"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact02.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=2}
		--89% of magic tricks are not magic. Technically, they are sorcery.
		SceneTable["-7200_03"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact07.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=3}
		...
		SceneTable["-7200_04"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact17.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=4}
		...
		SceneTable["-7200_05"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact26.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=5}
		--Marie Curie invented the theory of radioactivity, the treatment of radioactivity, and dying of radioactivity.
		SceneTable["-7200_06"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact41.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=6}
		...
		SceneTable["-7200_07"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact44.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=7}
		...
		SceneTable["-7200_08"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact46.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=8}
		--In 1948, at the request of a dying boy, baseball legend Babe Ruth ate seventy-five hot dogs, then died of hot dog poisoning.
		SceneTable["-7200_09"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact47.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=9}
		--William Shakespeare did not exist. His plays were masterminded in 1589 by Francis Bacon, who used a Ouija board to enslave play-writing ghosts.
		SceneTable["-7200_10"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact48.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=10}
		...
		SceneTable["-7200_11"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact49.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=11}
		--Whales are twice as intelligent, and three times as delicious, as humans.
		SceneTable["-7200_12"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact50.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=12}
		...
		SceneTable["-7200_13"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact51.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=13}
		--Edmund Hillary, the first person to climb Mount Everest, did so accidentally while chasing a bird.
		SceneTable["-7200_14"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact52.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=14}
		...
		SceneTable["-7200_15"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact53.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=15}
		...
		SceneTable["-7200_16"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact56.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=16}
		--The first commercial airline flight took to the air in 1914. Everyone involved screamed the entire way.
		SceneTable["-7200_17"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact57.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=17}
		--Before the Wright Brothers invented the airplane, anyone wanting to fly anywhere was required to eat 200 pounds of helium.
		SceneTable["-7200_18"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact60.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=18}
		...
		SceneTable["-7200_19"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact61.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=19}
		...
		SceneTable["-7200_20"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact62.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=20}
		--At some point in their lives 1 in 6 children will be abducted by the Dutch.
		SceneTable["-7200_21"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact63.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=21}
		--According to most advanced algorithms, the world's best name is Craig.
		SceneTable["-7200_22"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact64.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=22}
		--To make a photocopier, simply photocopy a mirror.
		SceneTable["-7200_23"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact65.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=23}
		--Dreams are the subconscious mind's way of reminding people to go to school naked and have their teeth fall out.
		SceneTable["-7200_24"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact66.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=24}
		--The first person to prove that cow's milk is drinkable was very, very thirsty.
		SceneTable["-7200_25"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact59.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=25}
		--The moon orbits the Earth every 27.32 days.
		SceneTable["-7200_26"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact24.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=26}
		...
		SceneTable["-7200_27"] = {vcd=CreateSceneEntity("scenes/npc/core02/fact05.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=27}
		--You are about to get me killed.
		SceneTable["-7200_28"] = {vcd=CreateSceneEntity("scenes/npc/core02/attachedfact04.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=28}
		--Fact: Space does not exist.
		SceneTable["-7200_29"] = {vcd=CreateSceneEntity("scenes/npc/core02/attachedfact20.vcd"),postdelay=0.01,next=nil,char="core02",noDingOff=true,noDingOn=true,idlegroup="core02_babble",idleorderingroup=29}

	
		-- ====================================== "Adventure" Core03
		--[[
		SceneTable["-7300_01"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble01.vcd"), postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idle=true,idleminsecs=0.2,idlemaxsecs=0.7,idlegroup="core03_babble",idleorderingroup=1}
		SceneTable["-7300_03"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble03.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=5}
		SceneTable["-7300_04"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble04.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=7}
		SceneTable["-7300_05"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble05.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=9}
		SceneTable["-7300_06"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble06.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=10}
		SceneTable["-7300_07"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble07.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=12}
		SceneTable["-7300_08"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble08.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=14}
		SceneTable["-7300_09"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble09.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=16}
		SceneTable["-7300_29"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble29.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=20}
		SceneTable["-7300_30"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble30.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=22}
		SceneTable["-7300_10"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble10.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=24}
		SceneTable["-7300_11"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble11.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=26}
		SceneTable["-7300_12"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble12.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=28}
		SceneTable["-7300_13"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble13.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=30}
		SceneTable["-7300_14"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble14.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=32}
		SceneTable["-7300_15"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble15.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=34}
		SceneTable["-7300_16"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble16.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=36}
		SceneTable["-7300_17"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble17.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=38}
		SceneTable["-7300_18"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble18.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=40}
		SceneTable["-7300_19"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble19.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=42}
		SceneTable["-7300_20"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble20.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=44}
		SceneTable["-7300_21"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble21.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=46}
		SceneTable["-7300_22"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble22.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=48}
		SceneTable["-7300_23"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble23.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=8,fires=[{entity="@glados",input="runscriptcode",parameter="sp_a4_finale4_set_thorn()",delay=0.0}]}
		SceneTable["-7300_29a"] = {vcd=CreateSceneEntity("scenes/npc/core03/encouragement13.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=60}
		SceneTable["-7300_31"] = {vcd=CreateSceneEntity("scenes/npc/core03/singing01.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=61}
		SceneTable["-7300_32"] = {vcd=CreateSceneEntity("scenes/npc/core03/singing02.vcd"),postdelay=2.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=62}
		SceneTable["-7300_33"] = {vcd=CreateSceneEntity("scenes/npc/core03/encouragement11.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=64}
		SceneTable["-7300_35"] = {vcd=CreateSceneEntity("scenes/npc/core03/encouragement09.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=67}
		]]
		...
		SceneTable["-7300_35"] = {vcd=CreateSceneEntity("scenes/npc/core03/encouragement09.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true}
		
		--fires=[{entity="fire_relay",input="trigger",parameter="",delay=0.0}]
		--encouragement01
		--encouragement11
		--SceneTable["-7300_24"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble24.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=24}
		--SceneTable["-7300_25"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble25.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=25}
		--SceneTable["-7300_26"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble26.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=26}
		--SceneTable["-7300_27"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble27.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=27}
		--SceneTable["-7300_28"] = {vcd=CreateSceneEntity("scenes/npc/core03/babble28.vcd"),postdelay=0.1,next=nil,char="core03",noDingOff=true,noDingOn=true,idlegroup="core03_babble",idleorderingroup=28}
...
function wheatley_monitor_break() 
	...
	playersmashes = playersmashes + 1
	local smashes = playersmashes
...
function sp_a4_stop_the_box_check_smash()
	if curMapName=="sp_a4_stop_the_box" then
		if not sp_a4_stop_the_box_did_smash and playersmashes>0 then
			return true
		end
	else
		return false
